...
void Thermistor::ReadTemp()
{
    ...
    for (;;)
    {
        ...
        if (!m)
        {
            this->T = (this->tt)[0].celsius;
            break;
        }
        if (m == l || m == r)
        {
            this->T = (this->tt)[this->tt_len-1].celsius;
            break;
        }
        
        int16_t a0 = (this->tt)[m-1].value;
        int16_t a1 = (this->tt)[m-0].value;
        if (a < a0)
        {
            r = m;
        }
        ...
        {
            int16_t T0 = (this->tt)[m-1].celsius;
            int16_t T1 = (this->tt)[m-0].celsius;
